...
$(call inherit-product-if-exists, vendor/lineage/config/moon.mk)
-include vendor/moon-prebuilts/packages/apps/Lawnchair/lawnchair.mk
...
PRODUCT_VERSION_MINOR = 00

# Change LineageFE Version with each major release.
BESTMOON_VERSION := BestMoonOS

LINEAGE_VERSION := BestMoonOS-v$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR)-$(shell date +%Y%m%d)-$(LINEAGE_BUILD)-$(BESTMOON_VERSION)
LINEAGE_DISPLAY_VERSION := LineageFE-v$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR)-$(LINEAGE_BUILD)-$(BESTMOON_VERSION)
